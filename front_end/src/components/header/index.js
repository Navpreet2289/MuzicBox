    ...
    return (
      <div styleName="header">
        <div styleName="header__wrapper">
          <div
            onClick={this.props.toggleMenu.bind(this, !this.props.is_menu_open)}
            styleName="sidebar"
          >
          ...
          <div styleName="logo-container">
            <Link to="/" styleName="logo" className="common-link">
              <img
                styleName="logo__icon"
                src="/static/img/muzicbox_small.png"
              />
            </Link>
          </div>
            ...
            <div styleName="auth__links-container">
              {window.opts.is_authenticated ? (
                ...
                <div>
                  <Link
                    to="/auth/"
                    styleName="auth__link auth--white-link  auth--transition"
                  >
                    <span>Sign In</span>
                  </Link>
