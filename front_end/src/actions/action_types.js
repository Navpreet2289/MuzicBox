...
export const SET_PLAYLIST_BACKUP = "SET_PLAYLIST_BACKUP"; // loading songs in to backup playlist
...
export const TOGGLE_SHUFFLED_MODE = "TOGGLE_SHUFFLED_MODE"; // toggle between shuffled mode in player and not shuffled
