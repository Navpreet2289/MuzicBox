...
class AudioAdmin(admin.ModelAdmin):
    ...
    fields = ['name', 'id', 'is_presentation', 'owner', 'audio_file_player', 'mbid', 'playcount', 'image', 'slug', 'bitrate',
              'length', 'audio_file', 'tags', 'album', 'year', 'artist', 'lyrics', 'created_date', 'modified_date']
